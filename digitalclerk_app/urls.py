...
urlpatterns = [
    ...
    url(r'^login_process_admin$', views.process_login_admin, name='login_process_admin'),
    url(r'^process_logout$', views.process_logout, name='process_logout'),
    url(r'^process_logout_admin$', views.process_logout_admin, name='process_logout_admin'),
